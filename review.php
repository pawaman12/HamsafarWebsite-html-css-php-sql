...
<section class="booking">
   ...
   <h1 class="heading-title">YOUR VALUABLE REVIEW</h1>
   ...
   <form action="review_form.php" method="post" class="book-form">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>name :</span>
            <input type="text" placeholder="enter your name" name="r_name">
         </div>
         <div class="inputBox">
            <span>email :</span>
            <input type="email" placeholder="enter your email" name="r_email">
         </div>
         <div class="inputBox">
            <span>Review :</span>
